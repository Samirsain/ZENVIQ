...
export const metadata: Metadata = city && service ? {
  ...
  openGraph: {
    ...
    url: `https://www.zenviqdigital.in/web-development-bikaner`,
  },
  alternates: { canonical: `https://www.zenviqdigital.in/web-development-bikaner` },
} : {}
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: `${service.title} in ${city.city}`, item: `https://www.zenviqdigital.in/web-development-bikaner` },
    ],
  }
