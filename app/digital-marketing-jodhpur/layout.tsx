...
export const metadata: Metadata = city && service ? {
  ...
  openGraph: {
    ...
    url: `https://www.zenviqdigital.in/digital-marketing-jodhpur`,
  },
  alternates: { canonical: `https://www.zenviqdigital.in/digital-marketing-jodhpur` },
} : {}
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: `${service.title} in ${city.city}`, item: `https://www.zenviqdigital.in/digital-marketing-jodhpur` },
    ],
  }
